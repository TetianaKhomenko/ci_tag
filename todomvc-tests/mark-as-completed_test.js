 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @ui', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @ui', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @ui', async ({ I, TodosPage }) => {
