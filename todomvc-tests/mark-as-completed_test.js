Feature('Mark as completed/not completed @step-06 @S3ae822a6')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @ui @T9a02d1b2', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @ui @T34bfb995', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T5b57e746', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @ui @Tcb05a897', async ({ I, TodosPage }) => {
